...
function Home({data, loading,error}) {
  ...
  return (
    <div className="App">
      ...
      {error && <div>{`${err} loading this page. Try Again.`}</div>}
      ...
      {data && data.map((film) => {
        return (
          <div key={film.episode_id} className='film'>
            ...
            <TruncatedString text={film.opening_crawl} maxLength={300}/>
            <Link to={`/movies/${film.episode_id}`}><p className="info">more info</p></Link>
